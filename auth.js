...
// unhandled rejection here means the request just hangs with no response,
// which a host's proxy (e.g. Render) eventually reports as a 502, not a
// normal 500. Every handler below is wrapped so a DB or JWT failure becomes
// a real, visible error (via the centralized handler in server.js) instead
// of a silent hang.
...
//                    the dashboard like anyone else — no center-picker gate before
